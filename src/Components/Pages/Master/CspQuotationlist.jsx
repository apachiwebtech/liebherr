...
export function CspQuotationlist(params) {
    ...
    const fetchQuotationlist = async (page) => {
        try {
            ...
            const response = await axiosInstance.get(`${Base_Url}/getquotationcsplist?${params.toString()}`, {
                headers: {
                    Authorization: token,
                },
            });
    ...
    const fetchFilteredData = async () => {
        try {
            ...
            const response = await axiosInstance.get(`${Base_Url}/getquotationcsplist?${params}`, {
                headers: {
                    Authorization: token,
                },
            }
    ...
    const sendtoedit = async (id) => {
        ...
        navigate(`/csp/quotation/${encrypted}`)
    };
