...
export function Csplisting(params) {
  ...
  const fetchComplaintlist = async (page) => {
    try {
      ...
      const response = await axiosInstance.get(`${Base_Url}/getcsplistmsp`, {
        headers: {
  ...
  const fetchFilteredData = async () => {
    try {
      ...
      const response = await axiosInstance.get(`${Base_Url}/getcsplistmsp?licare_code=${licare_code}`, {
        headers: {
          Authorization: token, // Send token in headers
        },
      });
                  ...
                  {filteredData.map((item, index) => {
                    ...
                    return (
                      <tr key={item.id} >
                        ...
                        <td style={rowStyle}>{item.licare_code}</td>
                        <td style={rowStyle}>{item.partner_name}</td>
