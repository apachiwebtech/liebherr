    ...
    try {
      ...
      if (confirmSubmission) {
        if (isEdit) {
          ...
          await axios
            .post(`${Base_Url}/postchildfranchise`, { ...formData })
            .then((response) => {
              setFormData({
                title: "",
                pfranchise_id: "",
                ...
                >
                  <div className="row">
                    ...
                    <div className="col-6">
                      ...
                      {/* Show error for Parent Franchise selection */}
                    </div>
                    ...
                    <div className="col-6">
                      <label
                        ...
                        className="input-field"
                        style={{
                          marginBottom: "15px", // Fixed typo from your original code
                          fontSize: "18px",
                        }}
                      >
                    ...
                    <div className="col-6">
                      <label
                        ...
                        className="input-field"
                        style={{
                          marginBottom: "15px", // Fixed style property typo from your original code
                          fontSize: "18px",
                        }}
                      >
                        Child Franchise(Contact No)
                      </label>
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Enter Child Franchise Master Contact info"
                         pattern="[0-9]{10}"
                        maxLength="15"
