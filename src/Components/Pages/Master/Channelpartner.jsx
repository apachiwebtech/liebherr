...
const Channelpartner = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.Channelpartner.trim()) { // Check if the Channelpartner is empty
        ...
        try {
            ...
            if (confirmSubmission) {
                if (isEdit) {
                    ...
                    await axios.put(`${Base_Url}/putcdata`, { ...formData, updated_by: updatedBy })
                        .then(response => {
                    ...
                    await axios.post(`${Base_Url}/postcdata`, { ...formData, created_by: createdBy })
                        .then(response => {
                           // window.location.reload();
                           setFormData({
                            Channelpartner : ''
                        ...
                        <div className="row mp0">
                            <div className="col-6">
                                <form onSubmit={handleSubmit} style={{ width: "50%" }} className="text-left">
                                    <div className="mb-3">
                                        <label htmlFor="ChannelpartnerInput" className="input-field" >Add Channel Partner</label>
                                        <input
                                            type="text"
                                        ...
                                        {errors.Channelpartner && <small className="text-danger">{errors.Channelpartner}</small>}
                                    ...
                                    <tbody>
                                        {currentUsers.map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                <td style={{ padding: '10px' }}>{item.Channelpartner}</td>
