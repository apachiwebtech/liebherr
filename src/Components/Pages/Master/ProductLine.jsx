...
const ProductLine = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.pline_code.trim()) {
      newErrors.pline_code = "Pline Code field is required.";
    }
          ...
          await axios.put(`${Base_Url}/putproductlinedata`, { ...formData, updated_by: updatedBy })
            ...
            .catch(error => {
              if (error.response && error.response.status === 409) {
                setDuplicateError('Duplicate entry, data already exists!');
              }
            });
        } else {
            ...
            <div className="row mp0">
              <div className="col-6">
                <form onSubmit={handleSubmit} style={{ width: "50%" }} className="text-left">
                  <div className="mb-3">
                    <label htmlFor="PlineCodeInput" className="input-field">Add Pline Code</label>
                    <input
                      type="text"
