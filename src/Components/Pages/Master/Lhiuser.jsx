...
const Lhiuser = () => {
    ...
    const handleSearch = (e) => {
        ...
        const filtered = users.filter((user) =>
            user.Lhiuser && user.Lhiuser.toLowerCase().includes(value)
        );
    ...
    const validateForm = () => {
        ...
        if (!formData.Lhiuser.trim()) { // Check if the Lhiuser is empty
        ...
        try {
            ...
            if (confirmSubmission) {
                if (isEdit) {
                    ...
                    await axios.put(`${Base_Url}/putlhidata`, { ...formData, updated_by: updatedBy })
                        .then(response => {
                    ...
                    await axios.post(`${Base_Url}/postlhidata`, { ...formData, created_by: createdBy })
                        .then(response => {
                           // window.location.reload();
                           setFormData({
                            Lhiuser : ''
                        ...
                        <div className="row mp0">
                            <div className="col-6">
                                <form onSubmit={handleSubmit} style={{ width: "50%" }} className="text-left">
                                    <div className="mb-3">
                                        <label htmlFor="LhiuserInput" className="input-field" >Add Lhi User</label>
                                        <input
                                            type="text"
                                        ...
                                        {errors.Lhiuser && <small className="text-danger">{errors.Lhiuser}</small>}
                                ...
                                <table className='table table-bordered table dt-responsive nowrap w-100 table-css' style={{ marginTop: '20px', tableLayout: 'fixed' }}>
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ padding: '12px 15px', textAlign: 'center' }}>Lhi User</th>
