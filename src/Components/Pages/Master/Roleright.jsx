...
const Roleright = () => {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = users.filter(
      (user) => user.Roleright && user.Roleright.toLowerCase().includes(value)
    );
  ...
  const validateForm = () => {
    ...
    if (!formData.Roleright || !formData.Roleright.trim()) {
      newErrors.Roleright = "Roleright Field is required.";
    }
                  ...
                  <div className="col-4">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        name="Roleright"
                        id="RolerightInput"
                        value={formData.Roleright}
                        onChange={handleChange}
                        placeholder="Enter FullName "
                      />
                      {errors.Roleright && (
                        <small className="text-danger">{errors.Roleright}</small>
                      )}
                      {duplicateError && (
                  ...
                  <tbody>
                    {currentUsers.map((item, index) => (
                      <tr key={item.id}>
                        ...
                        <td style={{ padding: "10px" }}>{item.Roleright}</td>
